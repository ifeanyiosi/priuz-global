        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center mb-6">
              ...
              <div className="h-10 w-10 bg-blue-600 rounded-full mr-3"></div>
              <span className="text-2xl font-bold">Pruiz Global</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0 text-gray-500 text-sm">
              &copy; {currentYear} Pruiz CA Global Services Ltd. All rights reserved.
            </div>
